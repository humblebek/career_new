<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="p-8">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-lg">{{ $question->careerTest->title }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100">
            <div class="p-8">
                <form method="POST" action="{{ route('admin.questions.update', $question) }}" class="space-y-8">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <select id="question_type"
                            ...
                            <option value="scale" {{ old('question_type', $question->question_type) === 'scale' ? 'selected' : '' }}>Scale (1-10)</option>
                    ...
                    <div class="flex justify-end space-x-4 pt-6">
                        <a href="{{ route('admin.tests.questions', $question->careerTest) }}"
